...
def attack(char_name: str, char_class: str) -> str:
    """Функция для вычисления значений урона по противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция для вычисления значений заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция для вычисления значений при применении спец. умений."""
    if char_class == 'warrior':
        return (f'{char_name} '
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки способностей."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбираем  и подтверждаем имя и класс персонажа."""
    approve_choice: str = ''
    char_class: str = ''
